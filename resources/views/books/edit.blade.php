...
<form class=" max-w-sm mx-auto bg-neutral-200 px-10 py-5 rounded-2xl shadow-2xl" action="{{ route('books.update', $book->id) }}"
    method="POST">
    <h1 class="font-bold text-2xl text-center ">Edit</h1>
    @csrf
    @method('PUT')
