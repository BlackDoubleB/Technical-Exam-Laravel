...
<form class="max-w-md mx-auto bg-white px-8 py-8 rounded-3xl shadow-xl border border-gray-200" action="{{ route('books.store') }}" method="POST">
    
    <h1 class="font-semibold text-2xl text-center text-gray-800 mb-6">Register</h1>
